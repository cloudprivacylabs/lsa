...
// func Ingest(baseID string, input interface{}, schema *ls.Layer) (ls.DocumentNode, error) {
// 	if schema == nil {
...
// // merge schema information into the input document and return a tree
// // of *ObjectNode, *ValueNode, *ArrayNode, *NullNode objects
// func merge(baseID string, input interface{}, schema *ls.Attribute) (ls.DocumentNode, error) {
// 	if input == nil {
// 		return ls.NewNullNode(baseID, "", schema), nil
// 	}
...
// func mergeAttributes(baseID string, input map[string]interface{}, attributes *ls.ObjectType, output *ls.ObjectNode) error {
...
// 		}
// 	}
// 	output.Children = make([]ls.DocumentNode, 0, len(input))
// 	for k, v := range input {
...
// func mergeObject(baseID string, input map[string]interface{}, schema *ls.Attribute) (ls.DocumentNode, error) {
// 	if schema == nil {
// 		ret := ls.NewObjectNode(baseID, "", nil)
// 		for k, v := range input {
...
// 			return nil, err
// 		}
// 		ret := ls.NewObjectNode(baseID, "", schema)
...
// func mergeArray(baseID string, input []interface{}, schema *ls.Attribute) (ls.DocumentNode, error) {
// 	if schema == nil {
// 		ret := ls.NewArrayNode(baseID, "", nil)
// 		for i := range input {
...
// 			return nil, err
// 		}
// 		ret := ls.NewArrayNode(baseID, "", schema)
// 		for i := range input {
...
// func mergeValue(baseID string, input interface{}, schema *ls.Attribute) (ls.DocumentNode, error) {
// 	if schema == nil {
// 		if input == nil {
// 			return ls.NewNullNode(baseID, "", nil), nil
// 		}
// 		return ls.NewValueNode(baseID, "", nil, input), nil
// 	}
...
// 			return ls.NewNullNode(baseID, "", schema), nil
// 		}
// 		return ls.NewValueNode(baseID, "", schema, input), nil
// 	}

...
func Ingest(baseID string, input interface{}, schema *ls.SchemaLayer) (ls.DocumentNode, error) {
	if schema == nil {
...
func mergeAttributes(baseID string, input map[string]interface{}, attributes *ls.Attributes, output *ls.ObjectNode) error {

...
func (ingester *Ingester) Ingest(target *digraph.Graph, baseID string, input Encodable) (ls.Node, error) {
...
func (ingester *Ingester) ingest(target *digraph.Graph, input Encodable, path []interface{}, schemaNode ls.Node) (*addedNode, error) {
...
func (ingester *Ingester) ingestPolymorphicNode(target *digraph.Graph, input Encodable, path []interface{}, schemaNode ls.Node) (*addedNode, error) {
...
func (ingester *Ingester) ingestValue(target *digraph.Graph, input Value, path []interface{}, schemaNode ls.Node) (*addedNode, error) {
	...
	var val interface{}
	json.Unmarshal(input.Value, &val)
	if val != nil {
		switch v := val.(type) {
		case bool:
		...
		case uint8, uint16, uint32, uint64, int8, int16, int32, int64, int, uint, float32, float64:
			newNode.SetValue(string(input.Value))

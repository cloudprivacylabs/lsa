...
var dateTests = []getSetTestCase{
	...
	},
	{
		...
		srcTypes:         []string{XSDDateTimeTerm},
		srcValue:         "2006-01-02T15:04:05Z",
		targetProperties: map[string]interface{}{MomentTimeFormatTerm: ls.StringPropertyValue(MomentTimeFormatTerm, "MM-DD-YYYY HH:mm:ss")},
	...
	},
	{
		...
		srcValue:      "20150203",
		srcProperties: map[string]interface{}{MomentTimeFormatTerm: ls.StringPropertyValue(MomentTimeFormatTerm, "YYYYMMDD")},
		targetTypes:   []string{XSDDateTerm},
	...
	},
	{
		...
		srcTypes:         []string{XSDTimeTerm},
		srcValue:         "15:04:05Z",
		targetProperties: map[string]interface{}{MomentTimeFormatTerm: ls.StringPropertyValue(MomentTimeFormatTerm, "HH:mm:ss")},
		targetTypes:      []string{PatternDateTimeTerm},
